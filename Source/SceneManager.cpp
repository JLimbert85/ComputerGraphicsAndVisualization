...
void SceneManager::LoadSceneTextures() {
	...
	bReturn = CreateGLTexture(
		"textures/brushedalum.jpg",
		"alum");

	bReturn = CreateGLTexture(
		"textures/whitemetal.jpg",
		"white");
	...
	bReturn = CreateGLTexture(
		"textures/plant-top.png",
		"large-plant");

	bReturn = CreateGLTexture(
		"textures/small-plant.png",
		"small-plant");

	bReturn = CreateGLTexture(
		"textures/wood-table.jpg",
		"wood-table");

	bReturn = CreateGLTexture(
		"textures/wood-planter.jpg",
		"wood-planter");
	...
	bReturn = CreateGLTexture(
		"textures/desktop.jpg",
		"desktop");

	bReturn = CreateGLTexture(
		"textures/browser.jpg",
		"browser");
...
void SceneManager::DefineObjectMaterials()
{
	...
	leatherMaterial.specularColor = glm::vec3(0.4f, 0.5f, 0.6f);
	leatherMaterial.shininess = 20;
	...
	tileMaterial.shininess = 30;
	tileMaterial.tag = "tile";
	m_objectMaterials.push_back(tileMaterial);

	OBJECT_MATERIAL glassMaterial;
	glassMaterial.diffuseColor = glm::vec3(0.3f, 0.3f, 0.3f);
	glassMaterial.specularColor = glm::vec3(1.0f);
	glassMaterial.shininess = 95;
...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("directionalLight.diffuse", 1.0f, 0.95f, 0.9f);
	m_pShaderManager->setVec3Value("directionalLight.specular", 1.0f, 1.0f, 1.0f);
	m_pShaderManager->setBoolValue("directionalLight.bActive", true);

	// point light 1
	m_pShaderManager->setVec3Value("pointLights[0].position", -6.0f, 8.0f, 0.0f);
	...
	// point light 2
	m_pShaderManager->setVec3Value("pointLights[1].position", 3.5f, 12.0f, 1.0f);
	m_pShaderManager->setVec3Value("pointLights[1].ambient", 0.05f, 0.05f, 0.05f);
	m_pShaderManager->setVec3Value("pointLights[1].diffuse", 0.6f, 0.6f, 0.5f);
	m_pShaderManager->setVec3Value("pointLights[1].specular", 0.9f, 0.9f, 0.9f);
	m_pShaderManager->setBoolValue("pointLights[1].bActive", true);
	// point light 3
	m_pShaderManager->setVec3Value("pointLights[2].position", -1.0f, 5.5f, 6.0f);
	m_pShaderManager->setVec3Value("pointLights[2].ambient", 0.05f, 0.05f, 0.05f);
	m_pShaderManager->setVec3Value("pointLights[2].diffuse", 0.3f, 0.3f, 0.2f);
	...
	m_pShaderManager->setVec3Value("pointLights[4].diffuse", 0.6f, 0.6f, 0.5f);
	m_pShaderManager->setVec3Value("pointLights[4].specular", 0.9f, 0.9f, 0.9f);
...
void SceneManager::RenderDesk() {
	...
	scaleXYZ = glm::vec3(17.0f, 0.6f, 11.0f);
	...
	positionXYZ = glm::vec3(1.75f, 2.0f, 3.5f);
...
void SceneManager::RenderWall() {
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(8.0f, 1.0f, 10.0f);
...
void SceneManager::RenderMonitor() {
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(7.0f, 4.0f, 0.1f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(3.5f, 7.5f, -1.5f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(3.2f, 1.0f, 1.8f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(3.46f, 7.5f, -1.46f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(7.001f, 1.3f, 0.101f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(3.34f, 4.9f, -1.34f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(2.0f, 5.5f, 0.1f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(3.5f, 5.0f, -2.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(2.8f, 2.35f, -1.3f);
...
void SceneManager::RenderKeyboard() {
	...
	// set the XYZ rotation for the mesh
	XrotationDegrees = 4.3f;
	YrotationDegrees = -45.0f;
	ZrotationDegrees = 0.0f;

	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.5f, 2.4f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(2.62f, 2.4f, 1.71f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.9f, 1.0f, 0.8f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.5f, 2.43f, 1.0f);
...
void SceneManager::RenderLaptop() {
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(4.5f, 0.1f, 3.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.0f, 2.35f, 3.5f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(4.5f, 3.0f, 0.1f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-0.75f, 3.8f, 2.25f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-1.8f, 2.41f, 3.3f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(2.2f, 1.0f, 1.3f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-0.775f, 3.9f, 2.275f);
...
void SceneManager::RenderMousepad() {
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(3.0f, 0.1f, 2.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.9f, 2.35f, 6.8f);
...
void SceneManager::RenderMouse() {
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.4f, 0.2f, 0.7f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.9f, 2.4f, 6.8f);
...
void SceneManager::RenderLargePlant() {
	// declare the variables for the transformations
	glm::vec3 scaleXYZ;
	float XrotationDegrees = 0.0f;
	float YrotationDegrees = 0.0f;
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(6.9f, 4.4f, 3.8f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.8f, 1.88f, 1.8f);
...
void SceneManager::RenderSmallPlant() {
	// declare the variables for the transformations
	glm::vec3 scaleXYZ;
	float XrotationDegrees = 0.0f;
	float YrotationDegrees = 0.0f;
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.3f, 2.45f, 1.5f);
	...
	SetShaderTexture("ceramic-potter");
	SetShaderMaterial("tile");
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.635f, 0.632f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.3f, 3.45f, 1.5f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.0f, 1.0f, 1.1f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.3f, 4.5f, 1.5f);
...
void SceneManager::RenderLamp() {
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.4f, 0.4f, 0.15f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(1.0f, 10.0f, -4.0f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.02f, 2.0f, 0.02f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.65f, 10.15f, -3.65f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.65f, 9.85f, -3.65f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.75f, 0.3f, 0.15f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-0.95f, 10.0f, -1.95f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-1.5f, 9.5f, -1.2f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.85f, 0.25f, 0.85f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-1.52f, 9.3f, -1.1f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.85f, 0.85f, 6.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-1.6f, 8.8f, -0.85f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-1.6f, 8.9f, -0.85f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-1.63f, 8.65f, -0.72f);
